...
public class Update extends AppCompatActivity {
                ...
                dbref.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if(dataSnapshot.exists()){
                            ...
                            String cast=dataSnapshot.child("caste").getValue().toString();
                            String brch=dataSnapshot.child("branch").getValue().toString();

                            setspinner(yr,brch,cast);
                            ...
                            upte.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    else if(stno.length()!=10){
                                        stno.setError("Enter Student Number Correctly of 10 digits");
                                        stno.requestFocus();
                                    }
                                    else {
                                        addStudent();
    ...
    private void setspinner(String year,String branch,String caste){
        if(year.equals("F.E")){
